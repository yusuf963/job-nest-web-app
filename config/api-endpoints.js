...
const dev = {
    ...
    jobPostCrudBaseApiUrl: "http://localhost:5000/jobpost/",
    courseCrudBaseApiUrl: "http://localhost:5000/courses/"
};
const prod = {
    ...
    courseCrudBaseApiUrl: "https://job-nest-api.onrender.com/courses/"
};
